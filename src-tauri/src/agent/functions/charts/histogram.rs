// src-tauri/src/agent/functions/charts/histogram.rs
//
// 直方图生成模块

use anyhow::{Context, Result};
use plotly::{Plot, Layout, Histogram};
...
<body>
    <div class="chart-header">
        ...
        <div class="chart-info">ID: histogram | Engine: plotly | Format: value列(数值)</div>
    </div>
    <div class="chart-container">{chart_html}</div>
</body>
</html>"#,
        title = options.title.clone().unwrap_or("直方图".to_string()),
