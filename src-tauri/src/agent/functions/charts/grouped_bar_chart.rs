// src-tauri/src/agent/functions/charts/grouped_bar_chart.rs
//
// 分组柱状图生成模块
...
pub fn generate_grouped_bar_chart(
...
<body>
    <div class="chart-header">
        ...
        <div class="chart-info">ID: grouped_bar | Engine: plotly | Format: x列(类别) + 分组列 + y列(数值)</div>
    </div>
    <div class="chart-container">{chart_html}</div>
</body>
</html>"#,
        title = options.title.clone().unwrap_or("分组柱状图".to_string()),
