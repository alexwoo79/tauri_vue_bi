// src-tauri/src/agent/functions/charts/pie_chart.rs
//
// 饼图生成模块

use anyhow::{Context, Result};
use plotly::{Plot, Layout, Pie};
...
<body>
    <div class="chart-header">
        ...
        <div class="chart-info">ID: pie_chart | Engine: plotly | Format: label列 + value列</div>
    </div>
    <div class="chart-container">{chart_html}</div>
</body>
</html>"#,
        title = options.title.clone().unwrap_or("饼图".to_string()),
