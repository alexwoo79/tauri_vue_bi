// src-tauri/src/agent/functions/charts/box_plot.rs
//
// 箱线图生成模块
...
<body>
    <div class="chart-header">
        ...
        <div class="chart-info">ID: box_plot | Engine: plotly | Format: y列(数值) [+ group列]</div>
    </div>
    <div class="chart-container">{chart_html}</div>
</body>
</html>"#,
        title = options.title.clone().unwrap_or("箱线图".to_string()),
